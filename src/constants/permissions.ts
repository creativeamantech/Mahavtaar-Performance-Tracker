...
export const DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  MANAGER: [VIEWS.DASHBOARD, VIEWS.DATA_ENTRY, VIEWS.CITY_PIVOT, VIEWS.TEAM_PIVOT, VIEWS.CITY_TEAM_MATRIX, VIEWS.AUDIT_LOG, VIEWS.EXPORT],
  EXECUTIVE: [VIEWS.DASHBOARD, VIEWS.DATA_ENTRY],
  VIEWER: [VIEWS.DASHBOARD, VIEWS.CITY_PIVOT],
};
